...
- Allows for conversational interaction.

- Components:
  
  - **Context:**
    - Each request and response is saved as context.
  
  - **Role:**
    - Mention the role that the bot is playing like an assistant or a peer.

- E.g.

  - *Getting response from the AI ans providing messages for context.*
    ```
  ...
  - *Collecting the messages, to inputs and responses.*
    ```
  ...
  - Getting and Displying response.
    ```
